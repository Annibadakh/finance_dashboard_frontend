                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {col.sortable && (
                      <div className="flex flex-col opacity-50">
                        <FiChevronUp size={12} className={sortConfig?.key === col.accessor && sortConfig.direction === 'asc' ? 'text-blue-600 dark:text-blue-400 opacity-100' : ''} />
                        <FiChevronDown size={12} className={`-mt-1 ${sortConfig?.key === col.accessor && sortConfig.direction === 'desc' ? 'text-blue-600 dark:text-blue-400 opacity-100' : ''}`} />
                      </div>
                    )}
                  </div>
                </th>
