  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      <Select
        ...
        onChange={(val) => onChange(isMulti ? val.map(v => v.value) : val.value)}
        isMulti={isMulti}
        ...
        classNames={{
          ...
          menu: () => "mt-2 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl shadow-lg z-50 overflow-hidden",
          ...
          multiValue: () => "bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded px-2 py-0.5 m-1",
          multiValueRemove: () => "hover:bg-blue-200 dark:hover:bg-blue-800 rounded ml-1 cursor-pointer",
        }}
        {...props}
      />
