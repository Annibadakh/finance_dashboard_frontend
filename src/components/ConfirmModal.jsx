...
const ConfirmModal = ({ isOpen, title, desc, confirmText, cancelText, type, onConfirm, onCancel }) => {
    ...
    <div className="fixed inset-0 z-100 flex items-center justify-center p-4 sm:p-0">
      ...
      <div className="relative bg-white dark:bg-gray-900 rounded-3xl shadow-2xl w-full max-w-md p-6 sm:p-8 transform transition-all animate-slide-up-fade">
        ...
        <div className="flex flex-col items-center text-center">
          {/* Icon Circle */}
          <div className={`w-16 h-16 rounded-full flex items-center justify-center mb-5 ${config[type].bg}`}>
